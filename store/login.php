...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <meta name="description" content="Naxyzz Store ./FqihXploit">
    <meta name="author" content="Store that created by Naxyzz And ./FqihXploit">
    <meta name="generator" content="Naxyzz V.0.1 ">
    <title>NAXYZZ | STORE</title>
...
<main class="form-signin w-100 m-auto">
  <form>
    <img class="mb-4" src="2.png" alt="logo" width="72" height="72">
    ...
    <div class="form-floating">
      <input required type="username" class="form-control" id="floatingInput" placeholder="Yanto">
