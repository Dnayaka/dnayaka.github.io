...
function ShowNotification() {
    ...
    if (!("Notification" in window)) {
        ...
        // Jika izin notifikasi telah diberikan, tampilkan notifikasi
        var notification = new Notification("Deadline", {
            icon: "islam.jpg", // Ubah dengan path icon notifikasi Anda
            body: "Your Task was over!."
        });
    } else if (Notification.permission !== "denied") {
        // Jika belum meminta izin, minta izin notifikasi
